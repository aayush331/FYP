...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=2719326557ltr&server=1">
...
<body>
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Recent tables" class="drop_button btn">Recent</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=hotel_booking&table=tbl_booking">`hotel_booking`.`tbl_booking`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=billinginvoice&table=inv_order">`billinginvoice`.`inv_order`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=hotel_booking&table=tbl_admin">`hotel_booking`.`tbl_admin`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=hotel_booking&table=feedback">`hotel_booking`.`feedback`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=hotel_booking&table=tbl_room">`hotel_booking`.`tbl_room`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=hotel_booking&table=tbl_category">`hotel_booking`.`tbl_category`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=simple-billing&table=login">`simple-billing`.`login`</a></li></ul></div><div class="drop_list"><button title="Favorite tables" class="drop_button btn">Favorites</button><ul id="pma_favorite_list"><li class="warp_link">There are no favorite tables.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="22416f5e46796a605c6f2b666e6d2f78">
    ...
    <div id="pma_console">
                ...
                <div class="message welcome">
                    ...
                    <span class="hide" id="instructions-1">
                        Press Enter to execute query                    </span>
                            ...
                            targetdb="hotel_booking" targettable="feedback">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `feedback`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="hotel_booking" targettable="tbl_admin">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `tbl_admin`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="billinginvoice" targettable="inv_order">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `inv_order`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="hotel_booking" targettable="tbl_booking">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `tbl_booking`</span>
                        </div>
